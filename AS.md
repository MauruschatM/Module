...
<section id="annotationsklassen">
    <div class="topic">
        ...
        <code>
            public @interface ClassMetadata {<br>
            &nbsp;&nbsp;String author();<br>
            &nbsp;&nbsp;String date();<br>
        ...
        <p>Verwendung:</p>
        <code>
            @Author(name = "Max Mustermann", date = "2024-07-20")<br>
        ...
        <code>
            Author authorInfo = MyClass.class.getAnnotation(Author.class);<br>
        ...
        <p>Empfehlungen:</p>
        <ul>
            <li>Vermeiden Sie übermäßige Verwendung von Annotationen.</li>
...
<section id="reflections">
    <div class="topic">
        ...
        <ul>
            <li>Informationen über eine Klasse und ihre Methoden, Felder und Konstruktoren ermitteln.</li>
...
<section id="lombok">
    <div class="topic">
        ...
        <ul>
            <li><code>@Getter</code> und <code>@Setter</code>: Generiert Getter- und Setter-Methoden für die Felder.
                <code>
            <pre>
            public class User {
            ...
            <li><code>@ToString</code>: Generiert eine <code>toString()</code>-Methode.
                <code>
            <pre>
            @ToString
            public class User {
            ...
            <li><code>@EqualsAndHashCode</code>: Generiert <code>equals()</code> und <code>hashCode()</code>-Methoden.
                <code>
            <pre>
            @EqualsAndHashCode
            public class User {
            ...
            <li><code>@AllArgsConstructor</code>: Generiert einen Konstruktor mit allen Feldern als Parameter.
                <code>
            <pre>
            @AllArgsConstructor
            public class User {
            ...
            <li><code>@NoArgsConstructor</code>: Generiert einen Standardkonstruktor.
                <code>
            <pre>
            @NoArgsConstructor
            public class User {
            ...
            <li><code>@Log</code>: Erstellt eine Logger-Instanz.
                <code>
            <pre>
            @Log
            public class User {
        ...
        <ul>
            <li><code>@Builder</code>: Erzeugt einen Builder für die Klasse.
                <code>
            <pre>
            @Builder
            public class User {
            ...
            <li><code>@Data</code>: Eine Kombination aus <code>@Getter</code>, <code>@Setter</code>,
        ...
        <ul>
            <li>Kann Probleme mit bestimmten IDEs oder Build-Tools verursachen.</li>
        ...
        <ul>
            <li>Stelle sicher, dass alle Teammitglieder mit Lombok vertraut sind.</li>
        ...
        <ul>
            <li><strong>Problem:</strong> Lombok-Annotations werden nicht erkannt.
...
<section id="architektur">
    <div class="topic">
        ...
        <ul>
            <li><strong>Präsentationsschicht:</strong> Schnittstelle für den Benutzer (z.B. <code>HTML</code>,
                <code>CSS</code>).
            </li>
        ...
        <ul>
            <li><strong>Webserver-Schicht:</strong> Vermittler zwischen Client und Anwendung (z.B. <code>Apache</code>,
                <code>NGINX</code>).
            </li>
        ...
        <ul>
            <li><strong>Komplexität:</strong> n-Tier ist komplexer durch zusätzliche Schichten.</li>
        ...
        <ul>
            <li>Vereinfachung des Client-Designs durch Reduzierung der Schnittstellen.</li>
            <li>Transparenter Zugriff auf zugrunde liegende Systeme.</li>
            <li>Unterstützung der Skalierbarkeit und Erweiterbarkeit.</li>
        </ul>
        <code>
            Beispiel: Middleware kann als API Gateway fungieren, das Anfragen vom Client an den entsprechenden
        ...
        <ul>
            <li>Feinere Granularität der Schichten.</li>
        ...
        <ul>
            <li><strong>Authentifizierung:</strong> Sicherstellung der Identität (z.B. <code>OAuth</code>).</li>
...
Datenbankserver (MongoDB)
    ...
    <div class="topic">
        ...
        <ul>
            <li><strong>Adapter:</strong> Konvertiert eine Schnittstelle in eine andere.</li>
        ...
        <code>
            Beispiel: Der Adapter Pattern kann verwendet werden, um zwei inkompatible Schnittstellen zu verbinden.
        </code>
...
<section id="jpa">
    <div class="topic">
        ...
        <ul>
            <li><code>@Entity</code>: Markiert eine Klasse als JPA-Entität.</li>
...
public void placeOrder(Customer customer, Order order) {
    ...
    customer.getOrders().add(order);
        ...
        <ul>
            <li><strong>JPQL</strong>: Eine SQL-ähnliche Sprache zur Abfrage von Entitäten.</li>
...
<section id="messaging">
    <div class="topic">
        ...
        <ul>
            <li>Einfachheit der Nutzung</li>
            <li>Plattformunabhängigkeit</li>
        </ul>
        <p>Nachteile:</p>
        <ul>
            <li>Hohe Latenz bei entfernten Aufrufen</li>
        ...
        <code>
            // Beispiel für eine Nachricht in Java
        ...
        <ul>
            <li>MQTT: Ein leichtgewichtiges Protokoll für IoT</li>
...
<section id="protobuf">
    <div class="topic">
        ...
        <ul>
            <li>Effizienter Speicherplatzverbrauch</li>
            <li>Schnelle Serialisierung und Deserialisierung</li>
            <li>Sprach- und plattformunabhängig</li>
        </ul>
        <p><strong>Nachteile:</strong></p>
        <ul>
            <li>Schwieriger zu debuggen als textbasierte Formate</li>
...
<section id="rest">
    <div class="topic">
        ...
        <ul>
            <li><strong>Client-Server-Architektur:</strong> Trennung von Benutzeroberfläche und Datenspeicherung.</li>
        ...
        <ul>
            <li><strong>GET:</strong> Ruft eine Ressource ab. Beispiel:
        ...
        <ul>
            <li><strong>200 OK:</strong> Die Anfrage war erfolgreich.</li>
...
<section id="concepts">
    <div class="topic">
        ...
        <ul>
            <li>Anwendungsserver (z.B. Java EE/Jakarta, Spring)</li>
            <li>Komposition</li>
        ...
        <ul>
            <li>SOA wird von technischen Bedürfnissen getrieben (Wiederverwendbarkeit), Microservices von
        ...
        <ul>
            <li>Paravirtualisierung: Gast-OS kommuniziert mit Hypervisor.</li>
        ...
        <ul>
            <li>Infrastruktur als Dienst (IaaS): z.B. AWS EC2</li>
            <li>Plattform als Dienst (PaaS): z.B. Google App Engine</li>
            <li>Software als Dienst (SaaS): z.B. Gmail, Dropbox</li>
        </ul>
        <p>Cloud-Computing bietet Vorteile wie einfache Skalierbarkeit, elastische Ressourcen und ein nutzungsbasiertes
            Zahlungsmodell.</p>
